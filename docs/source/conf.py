# -*- coding: utf-8 -*-
#
# DIMS Operational Concept Description documentation build configuration file, created by
...
project = u'DIMS Operational Concept Description'
copyright = u'2014-2016 David Dittrich'
...
htmlhelp_basename = 'DIMSOperationalConceptDescriptiondoc'
